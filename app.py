...
crop_model = torch.hub.load('yolov9', 'custom', 'yolov9/yolo9m.onnx', source='local')
...
fallback_model = onnxruntime.InferenceSession("export/fallback.onnx", providers=["CPUExecutionProvider"])
